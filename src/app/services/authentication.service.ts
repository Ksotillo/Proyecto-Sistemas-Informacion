  ...
  constructor(private firebAuth: AngularFireAuth) {} 
    ...
    // Actual getter for the Current User
      ...
      public isAdmin(): boolean {  
        const adminArr: Array<string> = ['30258079@correo.unimet.edu.ve', 'alberto.carrillo@correo.unimet.edu.ve' , 'gomez.manuel@correo.unimet.edu.ve', 'nleal@correo.unimet.edu.ve', 'k.invernon2017@correo.unimet.edu.ve', 'dortega@unimet.edu.ve', 'admin@gmail.com']
